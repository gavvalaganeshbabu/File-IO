...
namespace FIle_IO
{
    internal class File_IO
    {
        ...
        {
            string sourcePath = @"C:\Users\Admin\Myfile.txt";
            string destPath = @"C:\Users\Admin\Myfile2.txt";
            try
            {
        ...
        public static void DeleteFile()
        {
            try
            {
                string delFile = @"C:\Users\Admin\Myfile2.txt";
                if (true)
                {
                    File.Delete(delFile);
        ...
        internal void UpdateUserOnFile(List<Person> adressBookList)
        {
            throw new NotImplementedException();
        }
    }
